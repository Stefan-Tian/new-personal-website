...
const list = [
  {
    ...
    accomplishments: [
      ...
      'Built styleless component library for FreeFire projects that reduced development time by 16%.',
      'Used Nuxt on marketing projects to support dynamic meta changing, and server side rendering for better SEO.',
      'Introduced Cypress for end to end test automation.',
      'Contributed to internal auth library to simplify the login flow.',
      'Collaborated with backend engineers to develop multiple revenue events.',
    ],
  },
  {
    isCurrent: false,
  ...
  },
  {
    ...
    accomplishments: [
      ...
      'Created a feature to open modals across the site with URL.',
      'Switched all icons & illustrations to new ones and refactor multiple parts of the CSS codebase to follow BEM rules.',
